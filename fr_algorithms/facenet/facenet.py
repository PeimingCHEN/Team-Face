...
from fr_algorithms.facenet.nets.facenet import facenet
from fr_algorithms.facenet.utils.utils import preprocess_input, resize_image, show_config
...
class Facenet(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : os.path.join(BASE_DIR,'model_data/facenet_inception_resnetv1.h5'),
        #--------------------------------------------------------------------------#
        #   输入图片的大小。
        #--------------------------------------------------------------------------#
